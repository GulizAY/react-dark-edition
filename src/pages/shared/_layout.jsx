...
import { style } from "utils/Variables.jsx";
...
class Admin extends Component {
  ...
  handleItemColorClick = color => {
    this.setState({ color: color });
    localStorage.setItem('stateSidebarColor', color);
  };
  handleBackgroundColorClick = backgroundColor => {
    this.setState({ backgroundColor: backgroundColor });
    localStorage.setItem('stateSidebarBackgroundColor', backgroundColor);
  };
  ...
  render() {
    return (
      <div className="wrapper dark-edition">
        ...
        <div id="main-panel" className="main-panel dark-edition" ref="mainPanel">
          <AdminNavbar
            {...this.props}
          ...
          <FixedPlugin
            ...
            handleItemColorClick={this.handleItemColorClick}
